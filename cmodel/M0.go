...
func NewM0(data *Data, ncatsg, ncatcg int) (m *M0) {
...
func (m *M0) GetParameters() (kappa, omega, alphas, alphac float64) {
	return m.kappa, m.omega, m.alphas, m.alphac
}

// SetParameters sets the model parameter values.
func (m *M0) SetParameters(kappa, omega, alphas, alphac float64) {
	m.kappa = kappa
	m.omega = omega
	m.alphas = alphas
	m.alphac = alphac
